  ...
  return (
    <div>
      <Menu withArrow position="bottom-end" shadow="md" width={256}>
        <Menu.Target>
          <UnstyledButton className="inline-flex justify-center items-center text-blue-800">
          ...
          <Menu.Item>
            <div className="flex items-center gap-x-2 transition">
              ...
              <div className="text-sm">
                <div className="font-bold line-clamp-1 text-gray-800">{creds?.name}</div>
                <div className="text-gray-600 font-medium line-clamp-1">{creds?.username}</div>
              </div>
            </div>
          </Menu.Item>
          <Menu.Divider />
